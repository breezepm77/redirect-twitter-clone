...
function Home() {
    ...
    return (
        ...
        <div className="main__next">
            ...
            <img className="main__next--img" src={Profilepicture} alt="img"/>
        ...
        <div className="main__next2">
            ...
            <h2 className="main__next2--title">Ulug'bek</h2>
            </span>
            <p className="main__next2--text">Assalomu alaykum, bugun darsimiz to'xtatildi, seshanba kunidan davom ettiradigan bo'ldik.</p>
        ...
        <div className="main__next2">
            <span className="main__next2--span">
            <img className="main__next2--img" src={Baxtiyor} alt="img" />
            <h2 className="main__next2--title">Baxtiyor</h2>
            </span>
            <p className="main__next2--text">Assalomu alaykum, #uk  Uluģbek aka dars videolarini tashavorasmi olingan bosa</p>
           <ul className="main__next2--list">
               <li className="main__next2--item">
               <img className="main__next2--icon" src={commentLogo} alt="img" />
        ...
        <div className="main__next3">
            ...
            <p className="main__next2--text">Abedga... <br /> Kelinglar</p>
